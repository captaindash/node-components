...
describe('[Unit] Redis', function() {
  ...
  it('should export a connection property', function() {
    expect(Redis).to.have.property('connection').and
                         .to.be.an('object');
  });
  ...
  it('should expose a subscribe function', function() {
    expect(Redis).to.respondTo('subscribe');
  });

  it('should expose a unsubscribe function', function() {
    expect(Redis).to.respondTo('unsubscribe');
  });
